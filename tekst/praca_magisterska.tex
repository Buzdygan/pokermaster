...
które spisują się coraz lepiej w pojedynkach z ludźmi. W trakcie badań nad strategiami rozwinęły się algorytmy
takie jak "Monte Carlo Tree Search" czy opisywana w tej pracy metoda "Counterfactual Regret Minimization".
Odkrycie tej ostatniej w 2007 roku\cite{cfr} było przełomem w znajdowaniu aproksymacji równowagi Nasha w grach w postaci
ekstensywnej. Modyfikacje metody CFR są używane do znajdowania najlepszych istniejących strategii m.in w grze
Texas Holdem Poker.
